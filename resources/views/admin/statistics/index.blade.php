...
<div class="admin-page">
    <div class="admin-page-header">
        <h1 class="admin-page-title">Statistik</h1>
        <p class="admin-page-sub">Analitik mendalam penggunaan platform dan progres pembelajaran.</p>
    </div>
    <div class="placeholder-panel">
        ...
        <p class="placeholder-panel-desc">
            Modul <strong>Statistik</strong> akan dikembangkan pada Phase berikutnya.
