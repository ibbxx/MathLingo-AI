...
<div class="admin-page">
    <div class="admin-page-header">
        ...
        <p class="admin-page-sub">Kelola informasi profil dan keamanan akun administrator.</p>
    </div>
    <div class="placeholder-panel">
        ...
        <p class="placeholder-panel-desc">
            Modul <strong>Profil Admin</strong> akan dikembangkan pada Phase berikutnya.
