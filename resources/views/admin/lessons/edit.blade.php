<x-admin-layout title="Edit Pelajaran">
...
.editor-content h2 { font-size: 18px; font-weight: 700; margin: 16px 0 8px; }
.editor-content h3 { font-size: 15px; font-weight: 700; margin: 14px 0 6px; }
...
<div class="admin-page">
    ...
    <div class="breadcrumb">
        ...
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
        <span style="color:var(--color-text);font-weight:600;">Edit Pelajaran</span>
    </div>
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:24px;">
        <div>
            <h1 class="admin-page-title">Edit Pelajaran</h1>
            <p class="admin-page-sub">{{ $lesson->title }}</p>
        </div>
            ...
            <div class="panel-body">
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <div class="form-hint">Slug unik per kursus.</div>
                    ...
                    <div class="form-group full">
                        ...
                        <textarea id="description" name="description" class="form-textarea">{{ old('description', $lesson->description) }}</textarea>
                    ...
                    <div class="form-group full">
                        ...
                        <div class="image-upload">
                            <div class="image-upload-preview" id="imagePreviewBox">
                                @if($lesson->image_url)
                                    <img src="{{ $lesson->image_url }}" alt="Gambar pelajaran" id="imagePreviewImg">
                                @else
                    ...
                    <div class="form-group">
                        ...
                        <select id="lesson_type" name="lesson_type" class="form-select" required>
                            @foreach($lessonTypes as $value => $label)
                                <option value="{{ $value }}" {{ old('lesson_type', $lesson->lesson_type) === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="xp_reward" name="xp_reward" class="form-input"
                               value="{{ old('xp_reward', $lesson->xp_reward) }}" min="0" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="duration_minutes" name="duration_minutes" class="form-input"
                               value="{{ old('duration_minutes', $lesson->duration_minutes) }}" min="0" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sort_order" name="sort_order" class="form-input"
                               value="{{ old('sort_order', $lesson->sort_order) }}" min="0" required>
                    ...
                    <div class="form-group full">
                        ...
                        <div class="toggle-row">
                            ...
                            <label class="toggle-switch {{ old('is_active', $lesson->is_active) ? 'on' : '' }}" id="activeToggle" onclick="toggleActive()">
            ...
            <div class="panel-body" style="padding: 16px 24px;">
                ...
                <div class="editor-wrap">
                    <div class="editor-toolbar">
                        ...
                        <div class="sep"></div>
                        <button type="button" onclick="execCmd('formatBlock','h2')" style="font-size:11px;font-weight:700;width:auto;padding:0 6px;">H2</button>
                        <button type="button" onclick="execCmd('formatBlock','h3')" style="font-size:11px;font-weight:700;width:auto;padding:0 6px;">H3</button>
                        <button type="button" onclick="execCmd('formatBlock','p')" style="font-size:11px;width:auto;padding:0 6px;">P</button>
                        <div class="sep"></div>
                        ...
                        <div class="sep"></div>
                        <button type="button" onclick="insertTable()" title="Tabel">
                        ...
                        <div class="sep"></div>
                        <button type="button" onclick="insertMath()" style="font-size:11px;font-weight:700;width:auto;padding:0 6px;">∑</button>
                    ...
                    <div class="editor-content" id="editorContent"
                         ...
                         data-placeholder="Tulis konten pelajaran di sini...">{!! old('content', $lesson->content) !!}</div>
                    <div class="editor-footer">
                        <span class="editor-footer-tip">💡 Gunakan toolbar di atas. Formula matematika: klik ∑</span>
...
function insertTable() {
    const html = `<table><thead><tr><th>Kolom 1</th><th>Kolom 2</th><th>Kolom 3</th></tr></thead><tbody><tr><td>Data 1</td><td>Data 2</td><td>Data 3</td></tr></tbody></table><p><br></p>`;
    editorContent.focus();
...
function insertLink() {
    ...
    if (url) { document.execCommand('createLink', false, url); syncContent(); }
}
function insertMath() {
