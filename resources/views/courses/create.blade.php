    ...
    <div class="section-fade d1">
        <div class="page-hero">
            <div class="breadcrumb">
                ...
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>
                <span style="color:rgba(255,255,255,0.9);">Buat Kursus</span>
            </div>
            <h1 class="page-hero-title">Buat Kursus Baru</h1>
            <p class="page-hero-sub">Tambahkan jalur pembelajaran baru ke MathLingo AI.</p>
        </div>
    </div>
                ...
                <form method="POST" action="{{ route('courses.store') }}">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full">
                            ...
                            >
                            <span class="form-hint">Hanya huruf kecil, angka, dan tanda hubung. Digunakan dalam URL.</span>
                            @error('slug')
                                <span class="form-error">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                <option value="beginner"     {{ old('difficulty') === 'beginner'     ? 'selected' : '' }}>Pemula</option>
                                <option value="intermediate" {{ old('difficulty') === 'intermediate' ? 'selected' : '' }}>Menengah</option>
                                <option value="advanced"     {{ old('difficulty') === 'advanced'     ? 'selected' : '' }}>Lanjutan</option>
                            </select>
                            @error('difficulty')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            >
                            <span class="form-hint">Pengenal singkat untuk ikon kursus.</span>
                        </div>
                        ...
                        <div class="form-group full">
                            ...
                            <div class="color-picker-wrap">
                                <div style="position:relative;flex-shrink:0;">
                                    <div class="color-picker-preview" id="colorPreview" style="background:{{ old('color', '#2563EB') }};"></div>
                                    <input type="color" class="color-input-native" id="colorNative" value="{{ old('color', '#2563EB') }}" oninput="syncColor(this.value)">
                                </div>
                                <input
                                    type="text"
                                    id="color_hex"
                            ...
                            <span class="form-hint">Digunakan untuk pita warna dan aksen pada kartu kursus ini.</span>
                        </div>
...
// Sync color between native color picker and hex input
